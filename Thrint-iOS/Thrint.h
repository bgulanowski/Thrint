...
//  Thrint
//
//  Created by Brent Gulanowski on 2018-06-03.
//  Copyright © 2018 Lichen Labs. All rights reserved.
//

#import <UIKit/UIKit.h>

//! Project version number for Thrint_iOS.
FOUNDATION_EXPORT double Thrint_iOSVersionNumber;

//! Project version string for Thrint_iOS.
FOUNDATION_EXPORT const unsigned char Thrint_iOSVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <Thrint_iOS/PublicHeader.h>
